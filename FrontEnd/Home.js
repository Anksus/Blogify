        ...
        <div className="sidebar">
          ...
          <div>
            <div className="geometry-bar">
              ...
              <li><a href="polygons"> Polygons</a>
                <div className="submenu-01">
                  <ul>
                    <li><a href="XYZ"> Oriented area of Triangle</a></li>
                    <li><a href="XYZ"> Area of simple polygon</a></li>
                    <li><a href="XYZ"> Check if points belong to the convex polygon in O(log(N))</a></li>
                    <li><a href="XYZ"> Minkowski sum of convex polygon</a></li>
                    <li><a href="XYZ"> Pick's Theorem-area of lattice polygon</a></li>
                    <li><a href="XYZ"> Lattice points of non-lattice polygon</a></li>
                  </ul>
                </div>
              </li>
              <li><a href="Convex hull"> Convex hull</a>
                <div className="submenu-01">
                  <ul>
                    <li><a href="XYZ"> Convex hull construction using Graham's Scan</a></li>
                    <li><a href="XYZ"> Convex hull trick and Li chao Tree</a></li>
                  </ul>
                </div>
              </li>
              <li><a href="sweep-line"> Sweep Line</a>
                <div className="submenu-01">
                  <ul>
                    <li><a href="XYZ"> Search for a pair of intersecting segments</a></li>
                    <li><a href="XYZ"> Point location in O(log(N))</a></li>
                  </ul>
                </div>
              </li>
              <li><a href="miscellaneous"> Miscellaneous</a>
                <div className="submenu-01">
                  <ul>
                    <li><a href="XYZ"> Finding the nearest pair of points</a></li>
                    <li><a href="XYZ"> Delaunay traingulation and Voronoi diagram</a></li>
                    <li><a href="XYZ"> </a></li>
                  </ul>
                </div>
              </li>
          ...
          <div>
              <div className="misscell-bar">
                <li><a href="#Fundamen"> Sequences </a>
                  <div className="submenu-01">
                    <ul>
                      <li><a href="XYZ"> RMQ Tasks </a></li>
                      <li><a href="XYZ"> Longest Incresing subsequence</a></li>
                      <li><a href="XYZ"> Search the subsegment with the maximum / minimum sum</a></li>
                      <li><a href="XYZ"> K-th order statistic in O(N)</a></li>
                    </ul>
                  </div>
                </li>
                <li><a href="#Home"> Game theory </a>
                  <div className="submenu-01">
                    <ul>
                      <li><a href="XYZ"> Games on arbitrary graphs</a></li>
                      <li><a href="XYZ"> Spargue-Grundy theorem. Nim</a></li>
                    </ul>
                  </div>
                </li>
                <li><a href="#Home">  Schedules </a>
                  <div className="submenu-01">
                    <ul>
                      <li><a href="XYZ"> Scheduling jobs on the machine</a></li>
                      <li><a href="XYZ"> Scheduling jobs on two machines</a></li>
                      <li><a href="XYZ"> Optimal schedule of jobs given their deadlines and durations</a></li>
                    </ul>
                  </div>
                </li>
                <li><a href="#Home">  Miscellaneous  </a>
                  <div className="submenu-01">
                    <ul>
                      <li><a href="XYZ"> Josephus problem</a></li>
                      <li><a href="XYZ"> 15 puzzle game: Existance of the Solution</a></li>
                      <li><a href="XYZ"> The stern-Brocot Tree and Farey Sequences</a></li>
                    </ul>
                  </div>
                </li>
              </div>
